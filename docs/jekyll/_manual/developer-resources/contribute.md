...
---
## Contribute to flatpak

This page lists resources for developers who want to contribute to the flatpak ecosystem.

## Make technical contributions

### Contribute code to flatpak
...
Our [style guides]({% link _manual/contribute/style-guides/index.md %}) outline flatpak style for frontend, backend, documentation, and more, including best practices. Please read through them before you start editing or coding!  
